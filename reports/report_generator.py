...
def generate_report(target_url: str, vulnerabilities: list,
    ...
    filename = f"mahisec_{report_type}_report_{timestamp}.pdf"
    ...
    story.append(Paragraph("Mahisec Security Platform", title_style))
    ...
    story.append(Paragraph(
        "Generated by Mahisec Security Platform | For authorized testing only",
